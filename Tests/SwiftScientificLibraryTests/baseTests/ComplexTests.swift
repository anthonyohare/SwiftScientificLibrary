...
//        XCTAssertEqual(expc1.real(), -1.250174187327715, accuracy:1E-15)
//        XCTAssertEqual(expc1.imag(), 2.731680435331631, accuracy:1E-15)
//        XCTAssertEqual(logc1.real(), 0.825289927882638, accuracy:1E-15)
//        XCTAssertEqual(logc1.imag(), 1.067953115867036, accuracy:1E-15)
//        XCTAssertEqual(log10c1.real(), 0.358418861649762, accuracy:1E-15)
//        XCTAssertEqual(log10c1.imag(), 0.463806145152438, accuracy:1E-15)
//
//        c1 = Complex(real: 2.3, imag: -0.4)
//        expc1 = exp(value: c1)
//        logc1 = log(value: c1)
//        log10c1 = log10(value: c1)
//        XCTAssertEqual(expc1.real(), 9.186830406197782, accuracy:1E-15)
//        XCTAssertEqual(expc1.imag(), -3.884129597437974, accuracy:1E-15)
//        XCTAssertEqual(logc1.real(), 0.847807804337576, accuracy:1E-15)
//        XCTAssertEqual(logc1.imag(), -0.172190814522939, accuracy:1E-15)
//        XCTAssertEqual(log10c1.real(), 0.368198251138321, accuracy:1E-15)
//        XCTAssertEqual(log10c1.imag(), -0.074781520581739, accuracy:1E-15)
    }
...
//        XCTAssertEqual(sqrtc1.real(), 1.300488839264426, accuracy:1E-15)
//        XCTAssertEqual(sqrtc1.imag(), 0.768941623955507, accuracy:1E-15)
//        c1 = Complex(real: 2.3, imag: -0.4)
//        sqrtc1 = sqrt(value: c1)
//        XCTAssertEqual(sqrtc1.real(), 1.522255482168770, accuracy:1E-15)
//        XCTAssertEqual(sqrtc1.imag(), -0.131383990626237, accuracy:1E-15)
    }
}
